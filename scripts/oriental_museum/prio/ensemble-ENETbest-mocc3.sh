...
python main.py --lr=-4.8 --optimiser=Adam --ensemble \
    ...
    --test_ckpt_path ".results/bsz32-lws1-resize-by-model-oriental-museum-['instance']-minocc=3-seed2667_enetb3-epoch=92.ckpt" ".results/bsz32-lws1-resize-by-model-oriental-museum-['instance']-minocc=3-seed2667_enetb4-epoch=97.ckpt" ".results/bsz32-lws1-resize-by-model-oriental-museum-['instance']-minocc=3-seed2667_enetb5-epoch=98.ckpt" ".results/bsz32-lws1-resize-by-model-oriental-museum-['instance']-minocc=3-seed2667_enetb6-epoch=74.ckpt" ".results/bsz16-lws1-resize-by-model-oriental-museum-['instance']-minocc=3-seed2667_enetb7-epoch=92.ckpt" \
