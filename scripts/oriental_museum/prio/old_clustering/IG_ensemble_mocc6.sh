...
#SBATCH --job-name IG_ensemble_mocc6
#SBATCH --gres gpu:1
#SBATCH -o ../../../.results/IG_ensemble_mocc6.out
cd ../../..
...
python misc/saliency.py \
    ...
    --dataset=oriental-museum --device=1 --shuffle --metadata=instance --transforms=resize --num_workers=4 --dropout=0.5 --fc_intermediate=2048 --encoder_freeze=0 --dset_seed=2667 --min_occ=6 --loss_weight_scaling --ensemble --method IG --save_ensemble_memory
