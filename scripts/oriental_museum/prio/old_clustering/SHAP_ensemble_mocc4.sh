...
#SBATCH --job-name SHAP_ensemble_mocc4
#SBATCH --gres gpu:1
#SBATCH -o ../../../.results/SHAP_ensemble_mocc4.out
cd ../../..
...
python misc/saliency.py \
    ...
    --dataset=oriental-museum --device=0 --shuffle --metadata=instance --transforms=resize --num_workers=4 --dropout=0.5 --fc_intermediate=2048 --encoder_freeze=0 --dset_seed=2667 --min_occ=4 --loss_weight_scaling --ensemble --method SHAP --save_ensemble_memory
